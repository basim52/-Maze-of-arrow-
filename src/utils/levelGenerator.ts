...
export const HANDCRAFTED_LEVELS: Level[] = [
  ...
  // Level 16: Diamond Maze
  {
    ...
    arrows: [
      ...
      { id: '16-8', gridX: 7, gridY: 2, direction: 'right', color: 'lime', length: 2 },
      { id: '16-9', gridX: 10, gridY: 1, direction: 'down', color: 'yellow', length: 2 },
      { id: '16-10', gridX: 10, gridY: 4, direction: 'left', color: 'purple', length: 2 },
      { id: '16-11', gridX: 7, gridY: 5, direction: 'up', color: 'pink', length: 2 },
